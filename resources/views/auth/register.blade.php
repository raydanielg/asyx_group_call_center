...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.4s ease-out both;">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        {{-- Header --}}
        <div class="bg-gradient-to-br from-navy-600 to-navy-700 px-8 py-8 text-center">
            ...
            <p class="text-navy-100 text-sm mt-1">Join the AYS Call Center team</p>
        </div>
        ...
        <div class="p-8">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="first_name" type="text" name="first_name" value="{{ old('first_name') }}" required autocomplete="given-name" autofocus
                                class="w-full pl-11 pr-3 py-2.5 rounded-lg border @error('first_name') border-red-300 ring-2 ring-red-100 @else border-gray-200 @enderror focus:border-navy-500 focus:ring-2 focus:ring-navy-200 outline-none transition-all text-sm"
                                placeholder="John">
                        </div>
                        @error('first_name')
                    ...
                    <div>
                        ...
                        <input id="last_name" type="text" name="last_name" value="{{ old('last_name') }}" required autocomplete="family-name"
                            class="w-full px-3 py-2.5 rounded-lg border @error('last_name') border-red-300 ring-2 ring-red-100 @else border-gray-200 @enderror focus:border-navy-500 focus:ring-2 focus:ring-navy-200 outline-none transition-all text-sm"
                            placeholder="Doe">
                        @error('last_name')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email"
                            class="w-full pl-11 pr-4 py-2.5 rounded-lg border @error('email') border-red-300 ring-2 ring-red-100 @else border-gray-200 @enderror focus:border-navy-500 focus:ring-2 focus:ring-navy-200 outline-none transition-all text-sm"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="phone-display" type="tel" inputmode="numeric" autocomplete="tel"
                            class="w-full pl-[92px] pr-4 py-2.5 rounded-lg border @error('phone') border-red-300 ring-2 ring-red-100 @else border-gray-200 @enderror focus:border-navy-500 focus:ring-2 focus:ring-navy-200 outline-none transition-all text-sm font-mono tracking-wide"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" type="password" name="password" required autocomplete="new-password" minlength="8"
                            class="w-full pl-11 pr-4 py-2.5 rounded-lg border @error('password') border-red-300 ring-2 ring-red-100 @else border-gray-200 @enderror focus:border-navy-500 focus:ring-2 focus:ring-navy-200 outline-none transition-all text-sm"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password-confirm" type="password" name="password_confirmation" required autocomplete="new-password"
                            class="w-full pl-11 pr-4 py-2.5 rounded-lg border border-gray-200 focus:border-navy-500 focus:ring-2 focus:ring-navy-200 outline-none transition-all text-sm"
                            placeholder="Re-enter your password">
                    </div>
                </div>

                {{-- Submit --}}
                <button type="submit" class="w-full py-3 text-sm font-bold text-gray-900 bg-gradient-to-r from-copper-300 to-copper-400 hover:from-copper-400 hover:to-copper-500 rounded-lg shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2">
            ...
            <p class="text-center text-sm text-gray-500">
                ...
                <a href="{{ route('login') }}" class="font-semibold text-navy-600 hover:text-navy-700 transition-colors">Sign in</a>
            </p>
        </div>
    </div>

    <p class="mt-6 text-center text-xs text-gray-400">&copy; {{ date('Y') }} AYS Call Center. All rights reserved.</p>
</div>
