    ...
    <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
        ...
        <div class="relative bg-gradient-to-br from-navy-600 via-navy-700 to-navy-800 px-8 pt-8 pb-10 text-center overflow-hidden">
            ...
            <div class="relative">
                ...
                <h2 class="text-2xl font-extrabold text-white tracking-tight">Confirm Password</h2>
                <p class="text-navy-200 text-sm mt-1.5 font-medium">Secure area — please verify</p>
            </div>
        </div>

        {{-- Form --}}
        <div class="p-8">
            <p class="text-sm text-gray-500 text-center mb-6">Please confirm your password before continuing.</p>
            ...
            @if (Route::has('password.request'))
                <div class="mt-5 text-center">
                    <a href="{{ route('password.request') }}" data-ajax class="text-sm font-semibold text-navy-600 hover:text-navy-700 transition-colors">Forgot your password?</a>
                </div>
            @endif
        </div>
    </div>
