...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.4s ease-out both;">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-br from-navy-600 to-navy-700 px-8 py-8 text-center">
            ...
            <p class="text-navy-100 text-sm mt-1">We will send you a reset link</p>
        </div>
        ...
        <div class="p-8">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" class="inline-flex items-center gap-1 text-sm font-medium text-navy-600 hover:text-navy-700 transition-colors">
