    ...
    <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-sm font-semibold text-navy-600 hover:text-navy-700 transition-colors">Forgot password?</a>
                    @endif
                </div>
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-xs"><span class="px-3 bg-white text-gray-400 font-medium">New to AYS?</span></div>
            </div>
